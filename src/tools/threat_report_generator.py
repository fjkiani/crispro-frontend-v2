...
# --- Configuration ---
# load_dotenv() # Bypassed
# COMMAND_CENTER_URL = os.getenv("COMMAND_CENTER_URL") # Bypassed
# Using hardcoded URL as per Commander's orders.
COMMAND_CENTER_URL = "https://crispro--command-center-v11-path-lock-web-app.modal.run"

if not COMMAND_CENTER_URL:
    # This check is now redundant but kept for safety.
    raise ValueError("COMMAND_CENTER_URL is not set.")
