...
export default function DataReadinessPanel({ completeness, missing }) {
                        ...
                        <Box sx={{ position: 'relative', display: 'flex', flexDirection: 'column', gap: 0.5 }}>
                            ...
                            {typeof confidenceCap === 'number' && (
                                <Typography variant="caption" sx={{ color: '#f59e0b', mt: 0.5, display: 'block' }}>
                                    ⚠️ Confidence capped at {Math.round(confidenceCap * 100)}% due to missing data.
                                </Typography>
                            )}
                        </Box>
                    </Grid>
                        ...
                        {missing.length > 0 ? (
                            <Box>
                                <Typography variant="subtitle2" sx={{ color: '#94a3b8', mb: 1, fontWeight: 600 }}>
                                    Missing Fields Required for Higher Confidence:
                                </Typography>
                            ...
                            >
                                No critical fields missing for this level.
                            </Alert>
                        )}
                    </Grid>
                </Grid>
