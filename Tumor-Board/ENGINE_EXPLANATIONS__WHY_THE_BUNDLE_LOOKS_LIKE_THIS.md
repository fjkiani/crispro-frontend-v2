...
mission_queue:
  - "OPEN_QUESTIONS__MISSION_QUEUE.md"
---
...
The bundle-only packet is bounded to the captured payload (see `artifacts/payload.extracted.json` referenced in `TUMOR_BOARD_PACKET__BUNDLE_ONLY.md`).
