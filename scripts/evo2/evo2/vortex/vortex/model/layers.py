...
class TELinear(Linear):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # ===================================================================
        # == BEGIN DIRECT INTERVENTION - THE ZETA FORGE COMPLIANCE PATCH ==
        # ===================================================================
        # The version of Transformer Engine in the NGC container requires an
        # FP8 recipe to be present on the layer *before* model loading, but
        # the library's logic was insufficient. All attempts at subtle
        # monkey-patching have failed. We are now hardcoding the recipe
        # directly into the __init__ method to ensure compliance.
        # This is a scorched-earth solution to a defiant library.
        fp8_format = Format.HYBRID
        self.fp8_recipe = DelayedScaling(fp8_format=fp8_format, amax_history_len=16, amax_compute_algo="max")
        # ===================================================================
        # ==  END DIRECT INTERVENTION  ==
        # ===================================================================
