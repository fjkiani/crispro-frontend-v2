 ...
 */
const fetchStrictBundle = async ({ level = 'all', scenario_id = null, l3_scenario_id = null }) => {
...
export function useAyeshaTherapyFitBundle({ level = 'all', scenario_id = null, l3_scenario_id = null } = {}, options = {}) {
  return useQuery({
    queryKey: ['ayesha-therapy-fit-strict', { level, scenario_id, l3_scenario_id }],
    queryFn: () => fetchStrictBundle({ level, scenario_id, l3_scenario_id }),
