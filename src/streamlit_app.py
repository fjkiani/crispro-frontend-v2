...
# This adds the 'src' directory to the path, ensuring imports like 'from tools...'
# resolve to 'src/tools/...' instead of the decoy 'tools/' at the project root.
import sys
import os
...
def main():
    ...
    page_options = {
        ...
        # "🧬 Intelligent Guide Designer": intelligent_guide_designer_page # SURGICAL STRIKE: Page is disabled
    }
