...
export default function ProvenanceAccordion({ provenance }) {
    ...
    return (
        <Accordion defaultExpanded sx={{ mb: 2, bgcolor: 'action.hover', boxShadow: 'none', border: '1px solid', borderColor: 'divider' }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                    ...
                    {provenance.germline_status && (
                        <Box>
                            ...
                            <Typography variant="body2">
                                {provenance.germline_status === 'positive' ? '✅ Germline positive' :
